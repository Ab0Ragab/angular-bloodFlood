...
signUp(email: string, password: string): any{
  return this.http.post<AuthResponseData>(
    'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyARWMYWfpOk6ahsZVA_emS7xFpXwURZrEU',
    {
      email: email,
      password: password,
  ...
  logIn(email: string, password: string){
    return this.http.post<AuthResponseData>(
      'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyARWMYWfpOk6ahsZVA_emS7xFpXwURZrEU',
      {
        email: email,
        password: password,
        returnSecureToken: true
